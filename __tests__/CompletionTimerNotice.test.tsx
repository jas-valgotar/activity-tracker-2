// Overview: Verifies the configurable completion notice is visible at a target and can be dismissed immediately.
...
describe('CompletionTimerNotice', () => {
  ...
  it('shows the completion countdown and lets the user dismiss it', () => {
    ...
    expect(testRenderer!.root.findByProps({ children: 'Dismiss' })).toBeDefined();
    act(() => testRenderer!.root.findByProps({ accessibilityLabel: 'Dismiss completion notice' }).props.onPress());
